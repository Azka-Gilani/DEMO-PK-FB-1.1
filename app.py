...
def processRequest(req):
    ...
    baseurl="https://aarz.pk/search?postedBy=searchPage&view=&city_s=Islamabad&loc1=&price_min=0&price_max=0&land_area=&search_keyword=&day_post=Any&estate_agent=&purpose=Sell"
